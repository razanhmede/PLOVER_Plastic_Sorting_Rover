...
#
# $ python3 5-realTimeLabels.py --model mobilenet_v2.tflite --label coco_labels.txt
...
def main():
    model_path = "mobilenet_v2.tflite"  # Path to the detection model
    label_path = "coco_labels.txt"      # Path to the labels file
    ...
    while True:
        ...
        _ = InferenceTensorFlow(grey, model_path, output_file, label_path)
